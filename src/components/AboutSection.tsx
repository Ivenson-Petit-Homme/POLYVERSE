...
export const AboutSection: React.FC<AboutSectionProps> = ({ onOpenQuoteModal }) => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
      ...
      {/* Origin Story Card */}
      <ScrollReveal>
        <div className="bg-gradient-to-r from-[#0A2A4D] to-[#185FA5] rounded-2xl p-8 sm:p-12 text-white shadow-lg relative overflow-hidden">
      ...
      <div className="bg-white rounded-2xl p-8 border border-slate-200 space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-lg bg-[#D85A30] hover:bg-[#c24e27] text-white text-xs font-bold shadow-xs transition"
          >
