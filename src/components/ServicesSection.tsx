...
import servicesTechStudioImg from '../assets/images/services_tech_studio_1789429519582.jpg';
import {
  Palette,
  Code,
  CreditCard,
...
export const ServicesSection: React.FC<ServicesSectionProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
            ...
            {PILLARS.map((pillar) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center space-x-2 px-5 py-3 rounded-xl font-bold text-xs sm:text-sm transition-all duration-200 cursor-pointer ${
                    isActive
      ...
      <SectionDarkDivider label="Détails du Pilier Sélectionné" />
            ...
            <div className="lg:col-span-4 bg-[#F1EFE8] rounded-xl p-6 border border-slate-200 space-y-6">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full py-3 px-4 rounded-lg bg-[#D85A30] hover:bg-[#c24e27] text-white font-bold text-xs shadow-xs transition flex items-center justify-center space-x-2 cursor-pointer"
                >
      ...
      <SectionDarkDivider label="Simulateur & Devis Personnalisé" />

      {/* Interactive Quote Estimator Tool with matching Tech Studio Background */}
      <ScrollReveal delay={0.2}>
        <section className="relative overflow-hidden rounded-3xl p-8 sm:p-12 text-white shadow-2xl border border-slate-700/80 bg-[#0A2A4D]">
          {/* High-visibility background image */}
          <div className="absolute inset-0 z-0">
            <img
              src={servicesTechStudioImg}
              alt="Services Tech Studio"
              referrerPolicy="no-referrer"
              className="w-full h-full object-cover object-center filter brightness-105 contrast-110"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#06152B]/95 via-[#0A2A4D]/90 to-[#103E6D]/85" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 bg-white text-[#0A2A4D] rounded-xl p-6 shadow-lg space-y-6 flex flex-col justify-between">
              ...
              <div className="space-y-3 pt-2">
                ...
                <button
                  onClick={onOpenQuoteModal}
                  className="w-full py-2.5 px-4 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold transition cursor-pointer"
                >
